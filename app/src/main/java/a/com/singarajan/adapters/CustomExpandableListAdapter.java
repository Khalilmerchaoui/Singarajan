package a.com.singarajan.adapters;
...
public class CustomExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.custom_list_item_layout, null);
        }
    ...
    public View getGroupView(int listPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.custom_list_group_layout, null);
        }
